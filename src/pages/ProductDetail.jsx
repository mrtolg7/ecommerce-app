        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <div className="flex items-center border rounded-lg overflow-hidden detail-quantity">
              <button onClick={() => decreaseQuantity()} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white " id="decreaseBtn">
                -
              </button>
              <span className="px-6 py-2 dark:text-white">{quantity}</span>
              <button onClick={() => increasedQuantity()} className="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white">
                +
              </button>
            </div>
          ...
          {/* Extra Info */}
          <div className="border-t dark:border-gray-700 pt-6 text-sm text-gray-500 dark:text-gray-400 space-y-2">
            <p>✔ Free shipping</p>
